    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        ...
        if (this.doubleClick && slot != null && state == 0 && this.inventorySlots.canMergeSlot(null, slot)) {
            ...
            if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
                ...
                managerHandleMouseClick(null, -999, Container.func_94534_d(0, this.dragSplittingLimit), ClickType.QUICK_CRAFT);
                ...
                managerHandleMouseClick(null, -999, Container.func_94534_d(2, this.dragSplittingLimit), ClickType.QUICK_CRAFT);
