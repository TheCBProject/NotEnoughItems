...
import codechicken.nei.util.ItemList.EverythingItemFilter;
import codechicken.nei.util.ItemList.PatternItemFilter;
...
public class SearchField extends TextField implements IItemFilterProvider {
    ...
    public IItemFilter getFilter() {
        ...
        List<IItemFilter> primary = new LinkedList<>();
        List<IItemFilter> secondary = new LinkedList<>();
