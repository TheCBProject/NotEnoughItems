...
public interface IContainerTooltipHandler {
     ...
     */
    void handleTooltip(GuiScreen gui, int mousex, int mousey, List<String> currenttip);
     ...
     * @param currenttip A list of strings, representing each line of the current tooltip as modified by other handlers
     */
    void handleItemDisplayName(GuiScreen gui, ItemStack itemstack, List<String> currenttip);
}
