 ...
 */
@Mod (modid = MOD_ID, name = MOD_NAME, version = MOD_VERSION, acceptedMinecraftVersions = MC_VERSION_DEP, updateJSON = UPDATE_URL, certificateFingerprint = "f1850c39b2516232a2108a7bd84d1cb5df93b261")
